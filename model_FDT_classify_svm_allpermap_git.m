...
dimensionality = 'pca'; %'pca' for performing dimensionality reduction of the input features
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i=1:size(combinations, 1)
    ...
    for j=1:length(group1_all)
        ...
        if strcmp(dimensionality, 'pca')
            [coeff, score, latent, tsquared, explained, mu] = pca(xxdata);
            DataAll1=score(1:NSUB1,1:10);
            DataAll2=score(NSUB1+1:NSUB1+NSUB2,1:10);
